...
module.exports = {
    One(data) {
        ...
        for(let key of source) {
            ...
            key.live_real_startime = moment(key.live_real_startime).format("YYYY-MM-DD HH:mm:ss");
            key.live_real_endtime = moment(key.live_real_endtime).format("YYYY-MM-DD HH:mm:ss");
