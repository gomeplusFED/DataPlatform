    ...
    tradeThree(data, dates) {
        ...
        for(var date of dates) {
            obj[date] = {
                ...
                tran_order_money_amount : 0,
                tred_pay_money_amount : 0,
                tred_cus_unit_price : 0,
                del_use_coupon_rate : 0,
                del_refund_amount: 0,
                tran_refund_pro_num : 0
            };
        }
        ...
        for(var date of dates) {
            newData.push({
                date: date,
                tred_order_all_amount : obj[date].tred_order_all_amount,
                tred_pay_all_amount : obj[date].tred_pay_all_amount,
                tran_order_money_amount : obj[date].tran_order_money_amount,
                tred_pay_money_amount : obj[date].tred_pay_money_amount,
                tred_cus_unit_price : obj[date].tred_cus_unit_price,
                del_use_coupon_rate : obj[date].del_use_coupon_rate,
                del_refund_amount: obj[date].del_refund_amount,
                tran_refund_pro_num : obj[date].tran_refund_pro_num
            });
        }
