...
/***/ function(module, exports, __webpack_require__) {
	...
	!function ($) {
	  ...
	  var Datetimepicker = function (element, options) {
	    ...
	    var yestoday = (new Date()).getTime() - 24*60*60*1000,
	      ...
	      calender = "<ul>"+
	            ...
	            "</ul>";
	    var template = this.bootcssVer === 3 ? DPGlobal.templateV3 : DPGlobal.template(calender,options);
	  ...
	  DPGlobal.template = function(calender,options){
	    var tmpl = '<div class="datetimepicker" index="'+ options.id +'">' +
	    calender +
	    '<div class="wrap">' +
