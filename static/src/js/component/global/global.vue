<template>
	<div class="global">
		...
		<m-date class="global_date" :style="{display: pageComponentsData['date_picker'].show? 'block':'none'}" :index="-1" :init-data="initData" :page-components-data="pageComponentsData" :component-type="'date_picker'" :argvs.sync='argvs'></m-date>
	</div>
</template>
<script>
	var Vue = require('Vue');
