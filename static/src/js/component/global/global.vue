<template>
	<div class="global">
		...
		<m-date v-show="pageComponentsData['date_picker'].show" :index="-1" :init-data="initData" :page-components-data="pageComponentsData" :component-type="'date_picker'" :argvs.sync='argvs'></m-date>
	</div>
</template>
<script>
	var Vue = require('Vue');
