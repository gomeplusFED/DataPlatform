...
.multi_option_show .panel-body ul{overflow-y: auto;border: 1px solid #ddd;border-radius: 10px;height: 408px;}
.multi_option_show .panel-body ul li{cursor: pointer;background: #fff;transition: all ease 0.2s;-webkit-transition: all ease 0.2s;padding: 0 8px;line-height: 32px;}
.multi_option_show .panel-body ul li:hover{background: rgba(0,0,0,0.1);}
.multi_option_show .panel-body ul li.active{background: #3389d4;color: #fff;}
