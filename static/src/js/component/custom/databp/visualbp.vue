    ...
    <div class='page-content'>
        <form class='form-inline'>
            ...
            <button id="search"
                    ...
                    data-toggle="popover"
                    data-content="请输入正确的url">检索页面</button>
        </form>
        ...
        <div id='container'
            ...
            <div class='tabpanel_content'
                ...
                <div class='html_content'
                     style='z-index: 2;'>
                    <iframe :class="{'pc-iframe': bpConfig.platform === 'PC', 'wap-iframe':  bpConfig.platform === 'H5'}"
                            frameborder='no'
                            border='0'
                            marginwidth='0'
                            marginheight='0'
                            id='iframenode'
                            src='{{iframe_url}}'
                            v-on:load="iframeload"
                            sandbox="allow-forms allow-popups allow-scripts allow-same-origin"></iframe>
                </div>
            </div>
        </div>
    </div>
    <m-bpinfo :loading.sync='loading'
              :bp-config.sync='bpConfig'></m-bpinfo>
</template>
<script>
var Vue = require('Vue');
var $ = require('jQuery');
