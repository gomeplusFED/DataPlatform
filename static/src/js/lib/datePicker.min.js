...
(function(root, factory) {
  ...
  //         }
  //     }
    var momentjs = require('./moment.min.js');
  ...
  // }
    ...
    DateRangePicker.prototype = {
        ...
        clickUnit: function(e) {
            ...
            // 禁止不符合规定日期选中
            if(this.dayUnit === '1'){ // 只能选周日
                this.isInvalidDate = function(date){
                    return false;
                }
            }
            if(this.dayUnit === '2'){ // 只能选周日
                this.isInvalidDate = function(date){
                    if(new Date(date._d).getDay() === 0){
                        return false;
                    }
                    return true;
                }
            }
            if(this.dayUnit === '3'){ // 只能选月末
                this.isInvalidDate = function(date){
                    var year = new Date(date._d).getFullYear();
                    var month = new Date(date._d).getMonth() + 1;
                    var lastDay = this.getLastDay(year,month);
                    if(new Date(date._d).getDate() === lastDay){
                        return false;
                    }
                    return true;
                }
