...
/***/ function(module, exports, __webpack_require__) {
	...
	var LimitList = __webpack_require__(289);
	...
	var Role = Vue.extend({
		...
		methods: {
			...
			modifyRole: function modifyRole(id, limited, exportLimit) {
				this.id = id;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LimitList = Vue.extend({
		...
		methods: {
			...
			parseLimitAll: function parseLimitAll() {

				return true;
			},
			parseLimit: function parseLimit(key, index) {},
