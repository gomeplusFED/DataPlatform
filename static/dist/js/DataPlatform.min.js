...
/***/ function(module, exports, __webpack_require__) {
	...
	var User = Vue.extend({
		...
		methods: {
			showRemark: function showRemark(ev) {
			...
			editRemark: function editRemark() {
				console.info(111);
			}
		}
	});
...
/***/ function(module, exports) {
	...
	module.exports = "\n<div class=\"row\" _v-3a9e151a=\"\">\n\t<div class=\"col-lg-12\" _v-3a9e151a=\"\">\n\t\t<div class=\"panel panel-default\" _v-3a9e151a=\"\">\n\t\t\t<div class=\"panel-heading\" _v-3a9e151a=\"\">\n\t\t\t\t<strong _v-3a9e151a=\"\">帐号列表</strong>\n\t\t\t</div>\n\t\t\t<div class=\"panel-body\" _v-3a9e151a=\"\">\n\t\t\t\t<div class=\"user_table_con\" _v-3a9e151a=\"\">\n\t\t\t\t\t<table class=\"table table-bordered table-hover user_table\" _v-3a9e151a=\"\">\n\t\t\t\t\t\t<thead _v-3a9e151a=\"\">\n\t\t\t\t\t\t\t<tr _v-3a9e151a=\"\">\n\t\t\t\t\t\t\t\t<th _v-3a9e151a=\"\">ID</th>\n\t\t\t\t\t\t\t\t<th _v-3a9e151a=\"\">姓名</th>\n\t\t\t\t\t\t\t\t<th _v-3a9e151a=\"\">帐号名</th>\n\t\t\t\t\t\t\t\t<th _v-3a9e151a=\"\">邮箱</th>\n\t\t\t\t\t\t\t\t<th _v-3a9e151a=\"\">部门</th>\n\t\t\t\t\t\t\t\t<th _v-3a9e151a=\"\">角色</th>\n\t\t\t\t\t\t\t\t<th _v-3a9e151a=\"\">备注</th>\n\t\t\t\t\t\t\t\t<th _v-3a9e151a=\"\">操作</th>\n\t\t\t\t\t\t\t</tr>\n\t\t\t\t\t\t</thead>\n\t\t\t\t\t\t<tbody _v-3a9e151a=\"\">\n\t\t\t\t\t\t\t<tr _v-3a9e151a=\"\">\n\t\t\t\t\t\t\t\t<td _v-3a9e151a=\"\">0001</td>\n\t\t\t\t\t\t\t\t<td _v-3a9e151a=\"\">骆也</td>\n\t\t\t\t\t\t\t\t<td _v-3a9e151a=\"\">luoye</td>\n\t\t\t\t\t\t\t\t<td _v-3a9e151a=\"\">luoye@gomeplus.com</td>\n\t\t\t\t\t\t\t\t<td _v-3a9e151a=\"\">美信技术部</td>\n\t\t\t\t\t\t\t\t<td width=\"200\" _v-3a9e151a=\"\">\n\t\t\t\t\t\t\t\t\t<span _v-3a9e151a=\"\">研发</span>\n\t\t\t\t\t\t\t\t\t<a href=\"javascript:;\" class=\"btn btn-default\" data-role=\"0\" _v-3a9e151a=\"\">修改<i class=\"fa fa-pencil-square-o\" _v-3a9e151a=\"\"></i></a>\n\t\t\t\t\t\t\t\t</td>\n\t\t\t\t\t\t\t\t<td width=\"300\" _v-3a9e151a=\"\">\n\t\t\t\t\t\t\t\t\t<span _v-3a9e151a=\"\">备注信息</span>\n\t\t\t\t\t\t\t\t\t<form class=\"form-inline remark\" @submit.prevent=\"editRemark()\" _v-3a9e151a=\"\">\n\t\t\t\t\t\t\t\t\t\t<a @click=\"showRemark($event)\" href=\"javascript:void(0);\" class=\"btn btn-default\" _v-3a9e151a=\"\">修改<i class=\"fa fa-pencil-square-o\" _v-3a9e151a=\"\"></i></a>\n\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" id=\"remark\" _v-3a9e151a=\"\">\n\t\t\t\t\t\t\t\t\t</form>\n\t\t\t\t\t\t\t\t</td>\n\t\t\t\t\t\t\t\t<td width=\"280\" _v-3a9e151a=\"\">\n\t\t\t\t\t\t\t\t\t<ul _v-3a9e151a=\"\">\n\t\t\t\t\t\t\t\t\t\t<li _v-3a9e151a=\"\"><a class=\"btn btn-default\" href=\"javascript:void(0)\" _v-3a9e151a=\"\">权限修改<i class=\"fa fa-pencil-square-o\" _v-3a9e151a=\"\"></i></a></li>\n\t\t\t\t\t\t\t\t\t\t<li _v-3a9e151a=\"\"><a class=\"btn btn-default\" href=\"javascript:void(0)\" _v-3a9e151a=\"\">禁用<i class=\"fa fa-remove\" _v-3a9e151a=\"\"></i></a></li>\n\t\t\t\t\t\t\t\t\t\t<li _v-3a9e151a=\"\"><a class=\"btn btn-default\" href=\"javascript:void(0)\" _v-3a9e151a=\"\">启用<i class=\"fa fa-check-square-o\" _v-3a9e151a=\"\"></i></a></li>\n\t\t\t\t\t\t\t\t\t</ul>\n\t\t\t\t\t\t\t\t</td>\n\t\t\t\t\t\t\t</tr>\n\t\t\t\t\t\t\t<tr _v-3a9e151a=\"\">\n\t\t\t\t\t\t\t\t<td _v-3a9e151a=\"\">0001</td>\n\t\t\t\t\t\t\t\t<td _v-3a9e151a=\"\">骆也</td>\n\t\t\t\t\t\t\t\t<td _v-3a9e151a=\"\">luoye</td>\n\t\t\t\t\t\t\t\t<td _v-3a9e151a=\"\">luoye@gomeplus.com</td>\n\t\t\t\t\t\t\t\t<td _v-3a9e151a=\"\">美信技术部</td>\n\t\t\t\t\t\t\t\t<td _v-3a9e151a=\"\">研发</td>\n\t\t\t\t\t\t\t\t<td _v-3a9e151a=\"\">备注信息</td>\n\t\t\t\t\t\t\t\t<td _v-3a9e151a=\"\">操作</td>\n\t\t\t\t\t\t\t</tr>\n\t\t\t\t\t\t</tbody>\n\t\t\t\t\t</table>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t\t<div class=\"panel-footer\" _v-3a9e151a=\"\">\n\t\t\t\t<m-pagination :pagination-conf=\"paginationConf\" _v-3a9e151a=\"\"></m-pagination>\n\t\t\t</div>\n\t\t</div>\n\t</div>\n</div>\n";
