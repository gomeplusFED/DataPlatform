...
function connect(app) {
    app.use(orm.express('mysql://' + mysql.username + ':' + mysql.pwd + '@' + mysql.host + '/' + mysql.database + '?timezone=CST', {
        define: function(db, models, next) {
            ...
            models.GroupOwner = db.define("tbl_rt_group_owner",{
                id : {type: 'number', key: true},
            ...
            models.GroupOwnerTendency = db.define("tbl_rt_group_owner_tendency",{
                id : {type: 'number', key: true},
                new_owner_num : Number,
                total_new_owner_num : Number,
                fans_num : Number,
            ...
            models.GroupOwnerDistribution = db.define("tbl_rt_group_owner_distribution",{
                id : {type: 'number', key: true},
                new_owner_num : Number,
                fans_num : Number,
                group_type : String,
            ...
            models.GroupOwnerTop = db.define("tbl_rt_group_owner_top",{
                id : {type: 'number', key: true},
                owner_id : Number,
                owner_name : String,
                new_fans_num : Number,
