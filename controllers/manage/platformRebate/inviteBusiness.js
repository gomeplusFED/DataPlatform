...
module.exports = (Router) => {
    ...
    Router = new api(Router, {
        ...
        filter(data, query, dates) {
            return filter.inviteBusinessTwo(data, query.filter_key, dates);
        }
    });
    ...
    Router = new api(Router,{
        ...
        filter(data, query, dates) {
            return filter.inviteBusinessThree(data, query.filter_key);
        }
    });
    ...
    Router = new api(Router,{
        ...
        filter(data, query) {
            return filter.inviteBusinessFour(data, query.page);
        },
        rows : [
